...
function hasBossCodingRules(text) {
  // 官方模板有稳定标记；手工合并过的存量项目则认可三块核心规则都在。
  if (text.includes("<!-- bosscoding:intro-start -->") && text.includes("<!-- bosscoding:intro-end -->")) {
    return true;
  }
  return ["## 导师模式", "## 干活流程", "## 红线"].every((heading) => text.includes(heading));
}
