 ...
 * 真要提交时硬拦；no-direct-push 挂在推送前。marker 是认领标记：只有带那一行的
 * 文件才是我们写的，才允许刷新。
 */
const HOOKS = [
  { name: "pre-commit", template: "main-worktree.sh", marker: "bosscoding:main-worktree-guard" },
  { name: "post-checkout", template: "main-worktree.sh", marker: "bosscoding:main-worktree-guard" },
  { name: "pre-push", template: "no-direct-push.sh", marker: "bosscoding:no-direct-push-guard" },
];
